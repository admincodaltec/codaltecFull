		...
		<div className='h-screen w-full relative pt-10 pb-24'>
			...
			<div className='relative h-full flex container justify-end items-end z-[3]'>
				<article className='max-w-sm'>
					<h1 className='text-yellow-500 text-end text-4xl font-extrabold tracking-wide'>
						{title}
					</h1>
					<span className='block h-1 w-96 bg-yellow-500 my-3' />
					<h3 className='text-white leading-[1] text-sm font-normal text-end mb-2 min-h-[48px]'>
						{description}
					</h3>
				</article>
			</div>
